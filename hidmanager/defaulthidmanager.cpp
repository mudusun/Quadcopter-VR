...
/***Quadcopter signals****/
void DefaultHidManager::heUp()
{

  emit signUp();
}

void DefaultHidManager::heDown()
{

    emit signDown();
}

void DefaultHidManager::heStart()
{
    emit signStart();
}

void DefaultHidManager::heStop()
{
    emit signStop();
}
...
void DefaultHidManager::heUpReleased()
{

  emit signUpReleased();
}

void DefaultHidManager::heDownReleased()
{

    emit signDownReleased();
}


void DefaultHidManager::hePitchForwardReleased()
{
    emit signPitchForwardReleased();
}
void DefaultHidManager::hePitchBackwardReleased()
{
    emit signPitchBackwardReleased();
}
void DefaultHidManager::heRollLeftReleased()
{
    emit signRollLeftReleased();
}
void DefaultHidManager::heRollRightReleased()
{
    emit signRollRightReleased();
}
void DefaultHidManager::heYawLeftReleased()
{
    emit signYawLeftReleased();
}
void DefaultHidManager::heYawRightReleased()
{
...
void DefaultHidManager::setupDefaultHidBindings() {
  ...
  QString ha_up =
      registerHidAction( "up",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heUp()) );

  QString ha_down =
      registerHidAction( "down",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heDown()) );

  QString ha_start =
      registerHidAction( "start",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heStart()) );

  QString ha_stop =
      registerHidAction( "Stop",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heStop()) );
  QString ha_pitchForward =
      registerHidAction( "PitchForward",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(hePitchForward()) );
  QString ha_pitchBackward =
      registerHidAction( "PitchBackward",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(hePitchBackward()) );
  QString ha_rollLeft =
      registerHidAction( "RollLeft",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heRollLeft()) );
  QString ha_rollRight =
      registerHidAction( "RollRight",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heRollRight()) );
  QString ha_yawLeft =
      registerHidAction( "YawLeft",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heYawLeft()) );
  QString ha_yawRight =
      registerHidAction( "YawRight",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heYawRight()) );

  QString ha_up_Released =
      registerHidAction( "upReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heUpReleased()) );

  QString ha_down_Released =
      registerHidAction( "downReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heDownReleased()) );

  QString ha_pitchForward_Released =
      registerHidAction( "PitchForwardReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(hePitchForwardReleased()) );
  QString ha_pitchBackward_Released =
      registerHidAction( "PitchBackwardReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(hePitchBackwardReleased()) );
  QString ha_rollLeft_Released =
      registerHidAction( "RollLeftReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heRollLeftReleased()) );
  QString ha_rollRight_Released =
      registerHidAction( "RollRightReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heRollRightReleased()) );
  QString ha_yawLeft_Released =
      registerHidAction( "YawLeftReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heYawLeftReleased()) );
  QString ha_yawRight_Released =
      registerHidAction( "YawRightReleased",
                         "Toggle: Simulation",
                         "Toggle simulation",
                         this, SLOT(heYawRightReleased()) );
  ...
  /***Quadcopter***/
  registerHidMapping( ha_up,                   new KeyPressInput( Qt::Key_Y ) );
  registerHidMapping( ha_down,                   new KeyPressInput( Qt::Key_N ) );
  registerHidMapping( ha_start,                   new KeyPressInput( Qt::Key_H ) );
  registerHidMapping( ha_stop,                   new KeyPressInput( Qt::Key_Space ) );
  registerHidMapping( ha_pitchForward,                   new KeyPressInput( Qt::Key_T ) );
  registerHidMapping( ha_pitchBackward,                   new KeyPressInput( Qt::Key_U ) );
  registerHidMapping( ha_rollLeft,                   new KeyPressInput( Qt::Key_B ) );
  registerHidMapping( ha_rollRight,                   new KeyPressInput( Qt::Key_M ) );
  registerHidMapping( ha_yawLeft,                   new KeyPressInput( Qt::Key_G ) );
  registerHidMapping( ha_yawRight,                   new KeyPressInput( Qt::Key_J ) );


  registerHidMapping( ha_up_Released,                   new KeyPressInput( Qt::Key_Y ) );
  registerHidMapping( ha_down_Released,                   new KeyPressInput( Qt::Key_N ) );
  registerHidMapping( ha_pitchForward_Released,                   new KeyPressInput( Qt::Key_T ) );
  registerHidMapping( ha_pitchBackward_Released,                   new KeyPressInput( Qt::Key_U ) );
  registerHidMapping( ha_rollLeft_Released,                   new KeyPressInput( Qt::Key_B ) );
  registerHidMapping( ha_rollRight_Released,                   new KeyPressInput( Qt::Key_M ) );
  registerHidMapping( ha_yawLeft_Released,                   new KeyPressInput( Qt::Key_G ) );
  registerHidMapping( ha_yawRight_Released,                   new KeyPressInput( Qt::Key_J ) );
